...
function InnerDashboard() {
  const { data: bundle, loading, error } = useJsonBundle<{
    ...
    municipalities: "/analyses/huishoudensgroei/results/municipalities.json",
    provinces: "/analyses/huishoudensgroei/results/provinces.json",
    region: "/analyses/huishoudensgroei/results/region.json",
    regionBySize: "/analyses/huishoudensgroei/results/region_by_size.json",
    provincesBySize: "/analyses/huishoudensgroei/results/provinces_by_size.json",
    lookups: "/analyses/huishoudensgroei/results/lookups.json",
  })
