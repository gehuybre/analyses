...
export function PrijsherzieningDashboard() {
  const { data: bundle, loading, error } = useJsonBundle<{
    ...
    monthly: "/analyses/prijsherziening-index-i-2021/results/monthly_indices.json",
    components: "/analyses/prijsherziening-index-i-2021/results/components.json",
    metadata: "/analyses/prijsherziening-index-i-2021/results/metadata.json",
  })
